...
class BusinessTestCase(unittest.TestCase):
    ...
    def test_Business(self):
        ...
        driver.find_elements_by_xpath("//span[contains(@id, 'switch') and star]").click()
        ...
        if len(table_cows) > 1:
            ...
            # print('**********00')
            # print(len(cus_attr_table_tbodys))
            # print('**********00')
            # for index in range(len(cus_attr_table_tbodys)):
            #     cus_attr_cows = cus_attr_table_tbodys[index].find_elements_by_tag_name('tr')
            #     print('**********11')
            #     print(index)
            #     print(len(cus_attr_cows))
            #     print('**********11')
            #     for cus_attr_cow in cus_attr_cows:
            #         checked = False
            #         cus_attr_element1 = cus_attr_cow.find_element_by_xpath("./td[1]")
            #         cus_attr_element2 = cus_attr_cow.find_element_by_xpath("./td[2]")
            #         print('**********12')
            #         print(cus_attr_element1.text)
            #         print(cus_attr_element2.text)
            #         print('**********12')
            #         if cus_attr_element2.text == '房产':
            #             cus_attr_element_value = cus_attr_element2.find_element_by_xpath("./following-sibling::td[1]")
            #             print('**********22')
            #             print(cus_attr_element_value.text)
            #             print('**********22')
            #             cus_attr_element_value_radios = cus_attr_element_value.find_elements_by_xpath(
            #                 "./*[@type='radio']")
            #             print(len(cus_attr_element_value_radios))
            #             for cus_attr_element_value_radio in cus_attr_element_value_radios:
            #                 cus_attr_element_value_radio.click()
            #                 checked = True
            #                 time.sleep(1)
            #                 break
            #         if cus_attr_element1.text == '房屋类型':
            #             cus_attr_element_value = cus_attr_element1.find_element_by_xpath("./following-sibling::td[1]")
            #             print('**********33')
            #             print(cus_attr_element_value.text)
            #             print('**********33')
            #             cus_attr_element_value_radios = cus_attr_element_value.find_elements_by_xpath(
            #                 # "./*[@type='radio' and contains(@value,'HOUSE_TYPE')]")
            #                 "./*[@type='radio']")
            #             print(len(cus_attr_element_value_radios))
            #             for cus_attr_element_value_radio in cus_attr_element_value_radios:
            #                 cus_attr_element_value_radio.click()
            ...
            #                 time.sleep(1)
            #                 break
            #         if cus_attr_element1.text == '建立时间':
            #             cus_attr_element_value = cus_attr_element1.find_element_by_xpath("./following-sibling::td[1]")
            #             print('**********34')
            #             print(cus_attr_element_value.text)
            #             print('**********34')
            #             cus_attr_element_value_text = cus_attr_element_value.find_element_by_xpath(
            #                 "./*[@type='text']")
            #             # print(len(cus_attr_element_value_text))
            #             cus_attr_element_value_text.click()
            #         #     # cus_attr_element_value.clear()
            #         #     # cus_attr_element_value.send_key(u'2000')
            #             driver.switchTo().frame(1)
            #             driver.findElement(By.xpath("//td[@onclick='day_Click(2016, 1, 1,0,0,0);']")).click()
            #             driver.switchTo().defaultContent()
            #             # driver.find_element_by_xpath("//td[@onclick='day_Click(2000, 1, 1,0,0,0);']").click()
            #         if cus_attr_element1.text == '房屋位置':
            #             cus_attr_element_value = cus_attr_element1.find_element_by_xpath("./following-sibling::td[1]")
            #             print('**********35')
            #             print(cus_attr_element_value.text)
            #             print('**********35')
            #             cus_attr_element_value_radios = cus_attr_element_value.find_elements_by_xpath(
            #                 "./*[@type='radio' and contains(@value,'HOUSE_WZ')]")
            #             print(len(cus_attr_element_value_radios))
            #             for cus_attr_element_value_radio in cus_attr_element_value_radios:
            #                 cus_attr_element_value_radio.click()
            #                 checked = True
            #                 time.sleep(1)
            #                 break
            #         if cus_attr_element1.text == '房屋面积':
            #             cus_attr_element_value = cus_attr_element1.find_element_by_xpath("./following-sibling::td[1]")
            #             print('**********36')
            #             print(cus_attr_element_value.text)
            #             print('**********36')
            #             cus_attr_element_value_radios = cus_attr_element_value.find_elements_by_xpath(
            #                 "./*[@type='radio' and contains(@value,'HOUSE_AREA')]")
            #             print(len(cus_attr_element_value_radios))
            #             for cus_attr_element_value_radio in cus_attr_element_value_radios:
            #                 cus_attr_element_value_radio.click()
            #                 checked = True
            #                 time.sleep(1)
            #                 break
            #         if cus_attr_element1.text == '市场价格':
            #             cus_attr_element_value = cus_attr_element1.find_element_by_xpath("./following-sibling::td[1]")
            #             print('**********37')
            #             print(cus_attr_element_value.text)
            #             print('**********37')
            #         #     cus_attr_element_value.click()
            #         #     cus_attr_element_value.clear()
            #         #     cus_attr_element_value.send_key(u'100')
            #             cus_attr_element_value_text = cus_attr_element_value.find_element_by_xpath(
            #                 "./*[@type='text']")
            #             # print(len(cus_attr_element_value_text))
            #             cus_attr_element_value_text.click()
            #             cus_attr_element_value_text.clear()
            #             cus_attr_element_value_text.send_key(u'100')
            #         if cus_attr_element1.text == '房产证':
            #             cus_attr_element_value = cus_attr_element1.find_element_by_xpath("./following-sibling::td[1]")
            #             print('**********36')
            #             print(cus_attr_element_value.text)
            #             print('**********36')
            #             cus_attr_element_value_radios = cus_attr_element_value.find_elements_by_xpath(
            #                 "./*[@type='radio' and contains(@value,'CUS_KHZZ_HOUSE_FCZ')]")
            #             print(len(cus_attr_element_value_radios))
            #             for cus_attr_element_value_radio in cus_attr_element_value_radios:
            #                 cus_attr_element_value_radio.click()
            #                 checked = True
            ...
            #                 break
                    ...
                    # house_type_element = cus_attr_table_tbodys[index].find_element_by_link_text(u'房屋类型')
                    # if house_type_element is not '':
                    #     house_type_element_value = cus_attr_cow.find_element_by_xpath("./preceding-sibling::td[1]")
                    #     print('000000000001')
                    #     print(house_type_element_value.text)
                    #     print('000000000001')
                    #     house_type_element_value_radios = house_type_element_value.find_elements_by_xpath("//*[@type='radio']")
                    #     print(len(house_type_element_value_radios))
                    #     for house_type_element_value_radio in house_type_element_value_radios:
                    #         house_type_element_value_radio.click()
                    #         checked = True
                    #         time.sleep(1)
                    #         break
                    # house_time_element = cus_attr_cow.find_element_by_link_text(u'建立时间')
                    # if house_time_element is not '':
                    #     house_type_element_value = cus_attr_cow.find_element_by_xpath("./preceding-sibling::td[1]")
                    #     print('000000000002')
                    #     print(house_type_element_value.text)
                    #     print('000000000002')
                    #     house_type_element_value.click()
                    #     house_type_element_value.clear()
                    #     house_type_element_value.send_key(u'2000')
                    #     checked = True



                #     if cus_attr_cow.find_element_by_xpath(
                # "//iframe[contains(@src,'/orf/order/businessOrder.shtml?')]"))

            #         cus_attr_values = cus_attr_cow.find_elements_by_tag_name('td')
            #         print('000000000000')
            #         print(cus_attr_values[0].text)
            #         print(len(cus_attr_values[0].text))
            #         print('000000000000')
            #         if 0 < len(cus_attr_values[0].text) < 3:
            #             # cus_attr_value_radios = cus_attr_cow.find_elements_by_xpath("//*[@type='radio']")
            #             cus_attr_value_radios = cus_attr_values[2].find_elements_by_xpath("//*[@type='radio']")
            #             print('000000000001')
            #             print(cus_attr_values[2].text)
            #             value_list = cus_attr_values[2].text.split()
            #             for value in value_list:
            #                 print(value)
            #             print(len(cus_attr_value_radios))
            #             print('000000000001')
            #             checked = False
            #             for cus_attr_value_radio in cus_attr_value_radios:
            #                 for i in range(len(value_list)):
            #                     if i is 0:
            #                         cus_attr_value_radio.click()
            #                         checked = True
            #                         time.sleep(1)
            #                         break
            #                 if checked is True:
            ...
            #         else:
            #             print('6666666660')
            #             value_list = cus_attr_values[1].text.split()
            #             print(len(value_list))
            #             print('6666666660')
            #             cus_attr_value_radios = cus_attr_values[1].find_elements_by_xpath("//*[@type='radio']")
            #             print('6666666661')
            #             print(len(cus_attr_value_radios))
            #             print('6666666661')
            #             if len(value_list) > 0 and len(cus_attr_value_radios) > 0:
            #                 for value in value_list:
            #                     print(value)
            #                 checked = False
            #                 for cus_attr_value_radio in cus_attr_value_radios:
            ...
            #             else:
            #                 print('777777777')
            #     # cus_attr_cow = cus_attr_table_tbodys[index].find_elements_by_tag_name('tr')[0]
            #     # print('11111111111111111111')
            #     # print(cus_attr_cow.find_elements_by_tag_name('td')[2].text)
            #     # cus_attr_value = cus_attr_cow.find_elements_by_tag_name('td')[-1]
            #     # cus_attr_value.find_elements_by_tag_name('label')[-1].click()
            #     time.sleep(2)
