...
#         select2-selection__choice
        personnel_loc = (By.ID,"select2-flowUserId-container")
        personnel_input_loc = (By.XPATH,"//*[@class='select2-search__field']")
        personnels_loc = (By.XPATH,"//li[starts-with(@class,'select2-results__option')]")
        self.Set_personnel(personnel_loc,personnel_input_loc, personnels_loc, "张子飞")
